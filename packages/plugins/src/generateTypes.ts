import type { Route, UnroutedContext } from '@unrouted/core'
...
function generateMethodStack(routes: Route[]) {
  // @ts-expect-error not booted
  const methodStack: Record<RouterMethod, Route[]> = {}
