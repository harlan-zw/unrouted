import { createUnrouted, useQuery, useParams, useBody, UnroutedUserConfig } from '../../../src'
...
export default (options : UnroutedUserConfig = {}) => {
    const { get, serve, group, handle, any, redirect, permanentRedirect, post } = createUnrouted({
        prefix: options.prefix ?? undefined,
    })

    // 3rd-party module
    any('**', cors() as Middleware)
